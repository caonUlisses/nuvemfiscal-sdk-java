...
public class InfoFornecDocDedRed {
  ...
  public InfoFornecDocDedRed() {
  }

  public InfoFornecDocDedRed CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public InfoFornecDocDedRed CPF(@javax.annotation.Nullable String CPF) {
    this.CPF = CPF;
    return this;
  }
  ...
  public InfoFornecDocDedRed NIF(@javax.annotation.Nullable String NIF) {
    this.NIF = NIF;
    return this;
  }
  ...
  public InfoFornecDocDedRed cNaoNIF(@javax.annotation.Nullable Integer cNaoNIF) {
  ...
  public InfoFornecDocDedRed CAEPF(@javax.annotation.Nullable String CAEPF) {
    this.CAEPF = CAEPF;
    return this;
  }
  ...
  public InfoFornecDocDedRed IM(@javax.annotation.Nullable String IM) {
    this.IM = IM;
    return this;
  }
  ...
  public InfoFornecDocDedRed xNome(@javax.annotation.Nullable String xNome) {
    this.xNome = xNome;
    return this;
  }
  ...
  public InfoFornecDocDedRed end(@javax.annotation.Nullable Endereco end) {
    this.end = end;
    return this;
  }
  ...
  public InfoFornecDocDedRed fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public InfoFornecDocDedRed email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InfoFornecDocDedRed infoFornecDocDedRed = (InfoFornecDocDedRed) o;
    return Objects.equals(this.CNPJ, infoFornecDocDedRed.CNPJ) &&
        Objects.equals(this.CPF, infoFornecDocDedRed.CPF) &&
        Objects.equals(this.NIF, infoFornecDocDedRed.NIF) &&
        Objects.equals(this.cNaoNIF, infoFornecDocDedRed.cNaoNIF) &&
        Objects.equals(this.CAEPF, infoFornecDocDedRed.CAEPF) &&
        Objects.equals(this.IM, infoFornecDocDedRed.IM) &&
        Objects.equals(this.xNome, infoFornecDocDedRed.xNome) &&
        Objects.equals(this.end, infoFornecDocDedRed.end) &&
        Objects.equals(this.fone, infoFornecDocDedRed.fone) &&
        Objects.equals(this.email, infoFornecDocDedRed.email);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CNPJ, CPF, NIF, cNaoNIF, CAEPF, IM, xNome, end, fone, email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InfoFornecDocDedRed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InfoFornecDocDedRed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InfoFornecDocDedRed is not found in the empty JSON string", InfoFornecDocDedRed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InfoFornecDocDedRed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InfoFornecDocDedRed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InfoFornecDocDedRed.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InfoFornecDocDedRed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InfoFornecDocDedRed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InfoFornecDocDedRed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InfoFornecDocDedRed.class));

       return (TypeAdapter<T>) new TypeAdapter<InfoFornecDocDedRed>() {
           @Override
           public void write(JsonWriter out, InfoFornecDocDedRed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InfoFornecDocDedRed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InfoFornecDocDedRed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InfoFornecDocDedRed
   * @throws IOException if the JSON string is invalid with respect to InfoFornecDocDedRed
   */
  public static InfoFornecDocDedRed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InfoFornecDocDedRed.class);
  }

  /**
   * Convert an instance of InfoFornecDocDedRed to an JSON string
   *
   * @return JSON string
   */
