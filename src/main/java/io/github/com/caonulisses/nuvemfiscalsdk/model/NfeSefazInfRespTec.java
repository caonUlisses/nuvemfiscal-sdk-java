...
public class NfeSefazInfRespTec {
  ...
  public NfeSefazInfRespTec() {
  }

  public NfeSefazInfRespTec CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public NfeSefazInfRespTec xContato(@javax.annotation.Nullable String xContato) {
  ...
  public NfeSefazInfRespTec email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public NfeSefazInfRespTec fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public NfeSefazInfRespTec idCSRT(@javax.annotation.Nullable Integer idCSRT) {
    this.idCSRT = idCSRT;
    return this;
  }
  ...
  public NfeSefazInfRespTec hashCSRT(@javax.annotation.Nullable String hashCSRT) {
  ...
  public boolean equals(Object o) {
    ...
    NfeSefazInfRespTec nfeSefazInfRespTec = (NfeSefazInfRespTec) o;
    return Objects.equals(this.CNPJ, nfeSefazInfRespTec.CNPJ) &&
        Objects.equals(this.xContato, nfeSefazInfRespTec.xContato) &&
        Objects.equals(this.email, nfeSefazInfRespTec.email) &&
        Objects.equals(this.fone, nfeSefazInfRespTec.fone) &&
        Objects.equals(this.idCSRT, nfeSefazInfRespTec.idCSRT) &&
        Objects.equals(this.hashCSRT, nfeSefazInfRespTec.hashCSRT);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NfeSefazInfRespTec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NfeSefazInfRespTec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NfeSefazInfRespTec is not found in the empty JSON string", NfeSefazInfRespTec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NfeSefazInfRespTec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NfeSefazInfRespTec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NfeSefazInfRespTec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NfeSefazInfRespTec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NfeSefazInfRespTec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NfeSefazInfRespTec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NfeSefazInfRespTec.class));

       return (TypeAdapter<T>) new TypeAdapter<NfeSefazInfRespTec>() {
           @Override
           public void write(JsonWriter out, NfeSefazInfRespTec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NfeSefazInfRespTec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NfeSefazInfRespTec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NfeSefazInfRespTec
   * @throws IOException if the JSON string is invalid with respect to NfeSefazInfRespTec
   */
  public static NfeSefazInfRespTec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NfeSefazInfRespTec.class);
  }

  /**
   * Convert an instance of NfeSefazInfRespTec to an JSON string
   *
   * @return JSON string
   */
