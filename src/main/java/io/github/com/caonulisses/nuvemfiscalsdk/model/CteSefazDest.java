...
public class CteSefazDest {
  ...
  private CteSefazEndereco enderDest;
  ...
  public CteSefazDest CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public CteSefazDest CPF(@javax.annotation.Nullable String CPF) {
    this.CPF = CPF;
    return this;
  }
  ...
  public CteSefazDest IE(@javax.annotation.Nullable String IE) {
    this.IE = IE;
    return this;
  }
  ...
  public CteSefazDest xNome(@javax.annotation.Nullable String xNome) {
    this.xNome = xNome;
    return this;
  }
  ...
  public CteSefazDest fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public CteSefazDest ISUF(@javax.annotation.Nullable String ISUF) {
    this.ISUF = ISUF;
    return this;
  }
  ...
  public CteSefazDest enderDest(@javax.annotation.Nonnull CteSefazEndereco enderDest) {
   ...
   */
  @javax.annotation.Nonnull
  public CteSefazEndereco getEnderDest() {
    return enderDest;
  }

  public void setEnderDest(@javax.annotation.Nonnull CteSefazEndereco enderDest) {
    this.enderDest = enderDest;
  }


  public CteSefazDest email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CteSefazDest cteSefazDest = (CteSefazDest) o;
    return Objects.equals(this.CNPJ, cteSefazDest.CNPJ) &&
        Objects.equals(this.CPF, cteSefazDest.CPF) &&
        Objects.equals(this.IE, cteSefazDest.IE) &&
        Objects.equals(this.xNome, cteSefazDest.xNome) &&
        Objects.equals(this.fone, cteSefazDest.fone) &&
        Objects.equals(this.ISUF, cteSefazDest.ISUF) &&
        Objects.equals(this.enderDest, cteSefazDest.enderDest) &&
        Objects.equals(this.email, cteSefazDest.email);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CNPJ, CPF, IE, xNome, fone, ISUF, enderDest, email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CteSefazDest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CteSefazDest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CteSefazDest is not found in the empty JSON string", CteSefazDest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CteSefazDest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CteSefazDest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CteSefazDest.openapiRequiredFields) {
      ...
      CteSefazEndereco.validateJsonElement(jsonObj.get("enderDest"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CteSefazDest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CteSefazDest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CteSefazDest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CteSefazDest.class));

       return (TypeAdapter<T>) new TypeAdapter<CteSefazDest>() {
           @Override
           public void write(JsonWriter out, CteSefazDest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CteSefazDest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CteSefazDest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CteSefazDest
   * @throws IOException if the JSON string is invalid with respect to CteSefazDest
   */
  public static CteSefazDest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CteSefazDest.class);
  }

  /**
   * Convert an instance of CteSefazDest to an JSON string
   *
   * @return JSON string
   */
