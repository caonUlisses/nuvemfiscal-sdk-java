...
public class DfeInutilizacao {
  ...
  public DfeInutilizacao() {
  }

  public DfeInutilizacao cnpj(@javax.annotation.Nullable String cnpj) {
    this.cnpj = cnpj;
    return this;
  }
  ...
  public DfeInutilizacao ano(@javax.annotation.Nullable Integer ano) {
    this.ano = ano;
    return this;
  }
  ...
  public void setAno(@javax.annotation.Nullable Integer ano) {
    this.ano = ano;
  }


  public DfeInutilizacao modelo(@javax.annotation.Nullable Integer modelo) {
    this.modelo = modelo;
    return this;
  }
  ...
  public DfeInutilizacao serie(@javax.annotation.Nullable Integer serie) {
    this.serie = serie;
    return this;
  }
  ...
  public DfeInutilizacao numeroInicial(@javax.annotation.Nullable Integer numeroInicial) {
  ...
  public void setNumeroInicial(@javax.annotation.Nullable Integer numeroInicial) {
    this.numeroInicial = numeroInicial;
  }


  public DfeInutilizacao numeroFinal(@javax.annotation.Nullable Integer numeroFinal) {
  ...
  public void setNumeroFinal(@javax.annotation.Nullable Integer numeroFinal) {
    this.numeroFinal = numeroFinal;
  }


  public DfeInutilizacao justificativa(@javax.annotation.Nullable String justificativa) {
  ...
  public DfeInutilizacao id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DfeInutilizacao ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public DfeInutilizacao status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DfeInutilizacao autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public DfeInutilizacao chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public DfeInutilizacao dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public DfeInutilizacao numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public DfeInutilizacao dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public DfeInutilizacao codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public DfeInutilizacao motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public DfeInutilizacao numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public DfeInutilizacao codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public DfeInutilizacao mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public DfeInutilizacao tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    DfeInutilizacao dfeInutilizacao = (DfeInutilizacao) o;
    return Objects.equals(this.cnpj, dfeInutilizacao.cnpj) &&
        Objects.equals(this.ano, dfeInutilizacao.ano) &&
        Objects.equals(this.modelo, dfeInutilizacao.modelo) &&
        Objects.equals(this.serie, dfeInutilizacao.serie) &&
        Objects.equals(this.numeroInicial, dfeInutilizacao.numeroInicial) &&
        Objects.equals(this.numeroFinal, dfeInutilizacao.numeroFinal) &&
        Objects.equals(this.justificativa, dfeInutilizacao.justificativa) &&
        Objects.equals(this.id, dfeInutilizacao.id) &&
        Objects.equals(this.ambiente, dfeInutilizacao.ambiente) &&
        Objects.equals(this.status, dfeInutilizacao.status) &&
        Objects.equals(this.autor, dfeInutilizacao.autor) &&
        Objects.equals(this.chaveAcesso, dfeInutilizacao.chaveAcesso) &&
        Objects.equals(this.dataEvento, dfeInutilizacao.dataEvento) &&
        Objects.equals(this.numeroSequencial, dfeInutilizacao.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, dfeInutilizacao.dataRecebimento) &&
        Objects.equals(this.codigoStatus, dfeInutilizacao.codigoStatus) &&
        Objects.equals(this.motivoStatus, dfeInutilizacao.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, dfeInutilizacao.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, dfeInutilizacao.codigoMensagem) &&
        Objects.equals(this.mensagem, dfeInutilizacao.mensagem) &&
        Objects.equals(this.tipoEvento, dfeInutilizacao.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cnpj, ano, modelo, serie, numeroInicial, numeroFinal, justificativa, id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DfeInutilizacao
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DfeInutilizacao.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DfeInutilizacao is not found in the empty JSON string", DfeInutilizacao.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DfeInutilizacao.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DfeInutilizacao` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DfeInutilizacao.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DfeInutilizacao' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DfeInutilizacao> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DfeInutilizacao.class));

       return (TypeAdapter<T>) new TypeAdapter<DfeInutilizacao>() {
           @Override
           public void write(JsonWriter out, DfeInutilizacao value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DfeInutilizacao read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DfeInutilizacao given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DfeInutilizacao
   * @throws IOException if the JSON string is invalid with respect to DfeInutilizacao
   */
  public static DfeInutilizacao fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DfeInutilizacao.class);
  }

  /**
   * Convert an instance of DfeInutilizacao to an JSON string
   *
   * @return JSON string
   */
