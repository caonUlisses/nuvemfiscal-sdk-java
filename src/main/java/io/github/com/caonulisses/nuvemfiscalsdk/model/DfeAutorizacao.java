...
public class DfeAutorizacao {
  ...
  public DfeAutorizacao() {
  }

  public DfeAutorizacao digestValue(@javax.annotation.Nullable String digestValue) {
  ...
  public DfeAutorizacao id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DfeAutorizacao ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public DfeAutorizacao status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DfeAutorizacao autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public DfeAutorizacao chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public DfeAutorizacao dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public DfeAutorizacao numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public DfeAutorizacao dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public DfeAutorizacao codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public DfeAutorizacao motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public DfeAutorizacao numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public DfeAutorizacao codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public DfeAutorizacao mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public DfeAutorizacao tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    DfeAutorizacao dfeAutorizacao = (DfeAutorizacao) o;
    return Objects.equals(this.digestValue, dfeAutorizacao.digestValue) &&
        Objects.equals(this.id, dfeAutorizacao.id) &&
        Objects.equals(this.ambiente, dfeAutorizacao.ambiente) &&
        Objects.equals(this.status, dfeAutorizacao.status) &&
        Objects.equals(this.autor, dfeAutorizacao.autor) &&
        Objects.equals(this.chaveAcesso, dfeAutorizacao.chaveAcesso) &&
        Objects.equals(this.dataEvento, dfeAutorizacao.dataEvento) &&
        Objects.equals(this.numeroSequencial, dfeAutorizacao.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, dfeAutorizacao.dataRecebimento) &&
        Objects.equals(this.codigoStatus, dfeAutorizacao.codigoStatus) &&
        Objects.equals(this.motivoStatus, dfeAutorizacao.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, dfeAutorizacao.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, dfeAutorizacao.codigoMensagem) &&
        Objects.equals(this.mensagem, dfeAutorizacao.mensagem) &&
        Objects.equals(this.tipoEvento, dfeAutorizacao.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(digestValue, id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DfeAutorizacao
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DfeAutorizacao.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DfeAutorizacao is not found in the empty JSON string", DfeAutorizacao.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DfeAutorizacao.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DfeAutorizacao` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DfeAutorizacao.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DfeAutorizacao' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DfeAutorizacao> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DfeAutorizacao.class));

       return (TypeAdapter<T>) new TypeAdapter<DfeAutorizacao>() {
           @Override
           public void write(JsonWriter out, DfeAutorizacao value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DfeAutorizacao read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DfeAutorizacao given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DfeAutorizacao
   * @throws IOException if the JSON string is invalid with respect to DfeAutorizacao
   */
  public static DfeAutorizacao fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DfeAutorizacao.class);
  }

  /**
   * Convert an instance of DfeAutorizacao to an JSON string
   *
   * @return JSON string
   */
