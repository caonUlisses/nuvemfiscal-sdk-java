...
public class NfcomSefazICMS90 {
  ...
  public NfcomSefazICMS90() {
  }

  public NfcomSefazICMS90 CST(@javax.annotation.Nullable String CST) {
    this.CST = CST;
    return this;
  }
  ...
  public NfcomSefazICMS90 vBC(@javax.annotation.Nullable BigDecimal vBC) {
    this.vBC = vBC;
    return this;
  }
  ...
  public NfcomSefazICMS90 pICMS(@javax.annotation.Nullable BigDecimal pICMS) {
    this.pICMS = pICMS;
    return this;
  }
  ...
  public NfcomSefazICMS90 vICMS(@javax.annotation.Nullable BigDecimal vICMS) {
    this.vICMS = vICMS;
    return this;
  }
  ...
  public NfcomSefazICMS90 vICMSDeson(@javax.annotation.Nullable BigDecimal vICMSDeson) {
  ...
  public NfcomSefazICMS90 cBenef(@javax.annotation.Nullable String cBenef) {
    this.cBenef = cBenef;
    return this;
  }
  ...
  public NfcomSefazICMS90 pFCP(@javax.annotation.Nullable BigDecimal pFCP) {
    this.pFCP = pFCP;
    return this;
  }
  ...
  public NfcomSefazICMS90 vFCP(@javax.annotation.Nullable BigDecimal vFCP) {
    this.vFCP = vFCP;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NfcomSefazICMS90 nfcomSefazICMS90 = (NfcomSefazICMS90) o;
    return Objects.equals(this.CST, nfcomSefazICMS90.CST) &&
        Objects.equals(this.vBC, nfcomSefazICMS90.vBC) &&
        Objects.equals(this.pICMS, nfcomSefazICMS90.pICMS) &&
        Objects.equals(this.vICMS, nfcomSefazICMS90.vICMS) &&
        Objects.equals(this.vICMSDeson, nfcomSefazICMS90.vICMSDeson) &&
        Objects.equals(this.cBenef, nfcomSefazICMS90.cBenef) &&
        Objects.equals(this.pFCP, nfcomSefazICMS90.pFCP) &&
        Objects.equals(this.vFCP, nfcomSefazICMS90.vFCP);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CST, vBC, pICMS, vICMS, vICMSDeson, cBenef, pFCP, vFCP);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NfcomSefazICMS90
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NfcomSefazICMS90.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NfcomSefazICMS90 is not found in the empty JSON string", NfcomSefazICMS90.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NfcomSefazICMS90.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NfcomSefazICMS90` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NfcomSefazICMS90.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NfcomSefazICMS90.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NfcomSefazICMS90' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NfcomSefazICMS90> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NfcomSefazICMS90.class));

       return (TypeAdapter<T>) new TypeAdapter<NfcomSefazICMS90>() {
           @Override
           public void write(JsonWriter out, NfcomSefazICMS90 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NfcomSefazICMS90 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NfcomSefazICMS90 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NfcomSefazICMS90
   * @throws IOException if the JSON string is invalid with respect to NfcomSefazICMS90
   */
  public static NfcomSefazICMS90 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NfcomSefazICMS90.class);
  }

  /**
   * Convert an instance of NfcomSefazICMS90 to an JSON string
   *
   * @return JSON string
   */
