...
public class NfcomSefazEndeEmi {
  ...
  public NfcomSefazEndeEmi() {
  }

  public NfcomSefazEndeEmi xLgr(@javax.annotation.Nullable String xLgr) {
    this.xLgr = xLgr;
    return this;
  }
  ...
  public NfcomSefazEndeEmi nro(@javax.annotation.Nullable String nro) {
    this.nro = nro;
    return this;
  }
  ...
  public NfcomSefazEndeEmi xCpl(@javax.annotation.Nullable String xCpl) {
    this.xCpl = xCpl;
    return this;
  }
  ...
  public NfcomSefazEndeEmi xBairro(@javax.annotation.Nullable String xBairro) {
  ...
  public NfcomSefazEndeEmi cMun(@javax.annotation.Nullable String cMun) {
    this.cMun = cMun;
    return this;
  }
  ...
  public NfcomSefazEndeEmi xMun(@javax.annotation.Nullable String xMun) {
    this.xMun = xMun;
    return this;
  }
  ...
  public NfcomSefazEndeEmi CEP(@javax.annotation.Nullable String CEP) {
    this.CEP = CEP;
    return this;
  }
  ...
  public NfcomSefazEndeEmi UF(@javax.annotation.Nullable String UF) {
    this.UF = UF;
    return this;
  }
  ...
  public NfcomSefazEndeEmi fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public NfcomSefazEndeEmi email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NfcomSefazEndeEmi nfcomSefazEndeEmi = (NfcomSefazEndeEmi) o;
    return Objects.equals(this.xLgr, nfcomSefazEndeEmi.xLgr) &&
        Objects.equals(this.nro, nfcomSefazEndeEmi.nro) &&
        Objects.equals(this.xCpl, nfcomSefazEndeEmi.xCpl) &&
        Objects.equals(this.xBairro, nfcomSefazEndeEmi.xBairro) &&
        Objects.equals(this.cMun, nfcomSefazEndeEmi.cMun) &&
        Objects.equals(this.xMun, nfcomSefazEndeEmi.xMun) &&
        Objects.equals(this.CEP, nfcomSefazEndeEmi.CEP) &&
        Objects.equals(this.UF, nfcomSefazEndeEmi.UF) &&
        Objects.equals(this.fone, nfcomSefazEndeEmi.fone) &&
        Objects.equals(this.email, nfcomSefazEndeEmi.email);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(xLgr, nro, xCpl, xBairro, cMun, xMun, CEP, UF, fone, email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NfcomSefazEndeEmi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NfcomSefazEndeEmi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NfcomSefazEndeEmi is not found in the empty JSON string", NfcomSefazEndeEmi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NfcomSefazEndeEmi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NfcomSefazEndeEmi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NfcomSefazEndeEmi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NfcomSefazEndeEmi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NfcomSefazEndeEmi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NfcomSefazEndeEmi.class));

       return (TypeAdapter<T>) new TypeAdapter<NfcomSefazEndeEmi>() {
           @Override
           public void write(JsonWriter out, NfcomSefazEndeEmi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NfcomSefazEndeEmi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NfcomSefazEndeEmi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NfcomSefazEndeEmi
   * @throws IOException if the JSON string is invalid with respect to NfcomSefazEndeEmi
   */
  public static NfcomSefazEndeEmi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NfcomSefazEndeEmi.class);
  }

  /**
   * Convert an instance of NfcomSefazEndeEmi to an JSON string
   *
   * @return JSON string
   */
