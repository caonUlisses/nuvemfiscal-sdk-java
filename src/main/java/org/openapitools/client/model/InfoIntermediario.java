...
public class InfoIntermediario {
  ...
  public InfoIntermediario() {
  }

  public InfoIntermediario CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public InfoIntermediario CPF(@javax.annotation.Nullable String CPF) {
    this.CPF = CPF;
    return this;
  }
  ...
  public InfoIntermediario NIF(@javax.annotation.Nullable String NIF) {
    this.NIF = NIF;
    return this;
  }
  ...
  public InfoIntermediario cNaoNIF(@javax.annotation.Nullable Integer cNaoNIF) {
  ...
  public InfoIntermediario CAEPF(@javax.annotation.Nullable String CAEPF) {
    this.CAEPF = CAEPF;
    return this;
  }
  ...
  public InfoIntermediario IM(@javax.annotation.Nullable String IM) {
    this.IM = IM;
    return this;
  }
  ...
  public InfoIntermediario xNome(@javax.annotation.Nullable String xNome) {
    this.xNome = xNome;
    return this;
  }
  ...
  public InfoIntermediario end(@javax.annotation.Nullable Endereco end) {
    this.end = end;
    return this;
  }
  ...
  public InfoIntermediario fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public InfoIntermediario email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InfoIntermediario infoIntermediario = (InfoIntermediario) o;
    return Objects.equals(this.CNPJ, infoIntermediario.CNPJ) &&
        Objects.equals(this.CPF, infoIntermediario.CPF) &&
        Objects.equals(this.NIF, infoIntermediario.NIF) &&
        Objects.equals(this.cNaoNIF, infoIntermediario.cNaoNIF) &&
        Objects.equals(this.CAEPF, infoIntermediario.CAEPF) &&
        Objects.equals(this.IM, infoIntermediario.IM) &&
        Objects.equals(this.xNome, infoIntermediario.xNome) &&
        Objects.equals(this.end, infoIntermediario.end) &&
        Objects.equals(this.fone, infoIntermediario.fone) &&
        Objects.equals(this.email, infoIntermediario.email);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InfoIntermediario
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InfoIntermediario.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InfoIntermediario is not found in the empty JSON string", InfoIntermediario.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InfoIntermediario.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InfoIntermediario` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InfoIntermediario.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InfoIntermediario.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InfoIntermediario' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InfoIntermediario> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InfoIntermediario.class));

       return (TypeAdapter<T>) new TypeAdapter<InfoIntermediario>() {
           @Override
           public void write(JsonWriter out, InfoIntermediario value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InfoIntermediario read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InfoIntermediario given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InfoIntermediario
   * @throws IOException if the JSON string is invalid with respect to InfoIntermediario
   */
  public static InfoIntermediario fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InfoIntermediario.class);
  }

  /**
   * Convert an instance of InfoIntermediario to an JSON string
   *
   * @return JSON string
   */
