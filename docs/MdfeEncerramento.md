...
|------------ | ------------- | ------------- | -------------|
|**dataEncerramento** | **LocalDate** | Data que o manifesto foi encerrado. |  [optional] |
|**uf** | **String** | UF de encerramento do manifesto. |  [optional] |
|**codigoMunicipio** | **String** | Código do Município de encerramento do manifesto. |  [optional] |
