...
public class MdfeSefazVeicReboqueProp {
  ...
  public MdfeSefazVeicReboqueProp() {
  }

  public MdfeSefazVeicReboqueProp CPF(@javax.annotation.Nullable String CPF) {
    this.CPF = CPF;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp RNTRC(@javax.annotation.Nullable String RNTRC) {
    this.RNTRC = RNTRC;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp xNome(@javax.annotation.Nullable String xNome) {
    this.xNome = xNome;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp IE(@javax.annotation.Nullable String IE) {
    this.IE = IE;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp UF(@javax.annotation.Nullable String UF) {
    this.UF = UF;
    return this;
  }
  ...
  public MdfeSefazVeicReboqueProp tpProp(@javax.annotation.Nullable Integer tpProp) {
    this.tpProp = tpProp;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MdfeSefazVeicReboqueProp mdfeSefazVeicReboqueProp = (MdfeSefazVeicReboqueProp) o;
    return Objects.equals(this.CPF, mdfeSefazVeicReboqueProp.CPF) &&
        Objects.equals(this.CNPJ, mdfeSefazVeicReboqueProp.CNPJ) &&
        Objects.equals(this.RNTRC, mdfeSefazVeicReboqueProp.RNTRC) &&
        Objects.equals(this.xNome, mdfeSefazVeicReboqueProp.xNome) &&
        Objects.equals(this.IE, mdfeSefazVeicReboqueProp.IE) &&
        Objects.equals(this.UF, mdfeSefazVeicReboqueProp.UF) &&
        Objects.equals(this.tpProp, mdfeSefazVeicReboqueProp.tpProp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MdfeSefazVeicReboqueProp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MdfeSefazVeicReboqueProp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MdfeSefazVeicReboqueProp is not found in the empty JSON string", MdfeSefazVeicReboqueProp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MdfeSefazVeicReboqueProp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MdfeSefazVeicReboqueProp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MdfeSefazVeicReboqueProp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MdfeSefazVeicReboqueProp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MdfeSefazVeicReboqueProp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MdfeSefazVeicReboqueProp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MdfeSefazVeicReboqueProp.class));

       return (TypeAdapter<T>) new TypeAdapter<MdfeSefazVeicReboqueProp>() {
           @Override
           public void write(JsonWriter out, MdfeSefazVeicReboqueProp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MdfeSefazVeicReboqueProp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MdfeSefazVeicReboqueProp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MdfeSefazVeicReboqueProp
   * @throws IOException if the JSON string is invalid with respect to MdfeSefazVeicReboqueProp
   */
  public static MdfeSefazVeicReboqueProp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MdfeSefazVeicReboqueProp.class);
  }

  /**
   * Convert an instance of MdfeSefazVeicReboqueProp to an JSON string
   *
   * @return JSON string
   */
