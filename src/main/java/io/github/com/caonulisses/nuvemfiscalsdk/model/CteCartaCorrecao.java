...
import io.github.com.caonulisses.nuvemfiscalsdk.model.CteInfCorrecao;
...
public class CteCartaCorrecao {
  ...
  public CteCartaCorrecao correcoes(@javax.annotation.Nonnull List<CteInfCorrecao> correcoes) {
    this.correcoes = correcoes;
    return this;
  }

  public CteCartaCorrecao addCorrecoesItem(CteInfCorrecao correcoesItem) {
  ...
  public CteCartaCorrecao id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CteCartaCorrecao ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public CteCartaCorrecao status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CteCartaCorrecao autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public CteCartaCorrecao chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public CteCartaCorrecao dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public CteCartaCorrecao numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public CteCartaCorrecao dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public CteCartaCorrecao codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public CteCartaCorrecao motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public CteCartaCorrecao numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public CteCartaCorrecao codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public CteCartaCorrecao mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public CteCartaCorrecao tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    CteCartaCorrecao cteCartaCorrecao = (CteCartaCorrecao) o;
    return Objects.equals(this.correcoes, cteCartaCorrecao.correcoes) &&
        Objects.equals(this.id, cteCartaCorrecao.id) &&
        Objects.equals(this.ambiente, cteCartaCorrecao.ambiente) &&
        Objects.equals(this.status, cteCartaCorrecao.status) &&
        Objects.equals(this.autor, cteCartaCorrecao.autor) &&
        Objects.equals(this.chaveAcesso, cteCartaCorrecao.chaveAcesso) &&
        Objects.equals(this.dataEvento, cteCartaCorrecao.dataEvento) &&
        Objects.equals(this.numeroSequencial, cteCartaCorrecao.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, cteCartaCorrecao.dataRecebimento) &&
        Objects.equals(this.codigoStatus, cteCartaCorrecao.codigoStatus) &&
        Objects.equals(this.motivoStatus, cteCartaCorrecao.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, cteCartaCorrecao.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, cteCartaCorrecao.codigoMensagem) &&
        Objects.equals(this.mensagem, cteCartaCorrecao.mensagem) &&
        Objects.equals(this.tipoEvento, cteCartaCorrecao.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(correcoes, id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CteCartaCorrecao
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CteCartaCorrecao.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CteCartaCorrecao is not found in the empty JSON string", CteCartaCorrecao.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CteCartaCorrecao.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CteCartaCorrecao` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CteCartaCorrecao.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CteCartaCorrecao.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CteCartaCorrecao' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CteCartaCorrecao> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CteCartaCorrecao.class));

       return (TypeAdapter<T>) new TypeAdapter<CteCartaCorrecao>() {
           @Override
           public void write(JsonWriter out, CteCartaCorrecao value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CteCartaCorrecao read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CteCartaCorrecao given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CteCartaCorrecao
   * @throws IOException if the JSON string is invalid with respect to CteCartaCorrecao
   */
  public static CteCartaCorrecao fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CteCartaCorrecao.class);
  }

  /**
   * Convert an instance of CteCartaCorrecao to an JSON string
   *
   * @return JSON string
   */
