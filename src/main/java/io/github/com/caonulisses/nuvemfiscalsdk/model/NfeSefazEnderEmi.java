...
public class NfeSefazEnderEmi {
  ...
  public NfeSefazEnderEmi() {
  }

  public NfeSefazEnderEmi xLgr(@javax.annotation.Nullable String xLgr) {
    this.xLgr = xLgr;
    return this;
  }
  ...
  public NfeSefazEnderEmi nro(@javax.annotation.Nullable String nro) {
    this.nro = nro;
    return this;
  }
  ...
  public NfeSefazEnderEmi xCpl(@javax.annotation.Nullable String xCpl) {
    this.xCpl = xCpl;
    return this;
  }
  ...
  public NfeSefazEnderEmi xBairro(@javax.annotation.Nullable String xBairro) {
  ...
  public NfeSefazEnderEmi cMun(@javax.annotation.Nullable String cMun) {
    this.cMun = cMun;
    return this;
  }
  ...
  public NfeSefazEnderEmi xMun(@javax.annotation.Nullable String xMun) {
    this.xMun = xMun;
    return this;
  }
  ...
  public NfeSefazEnderEmi UF(@javax.annotation.Nullable String UF) {
    this.UF = UF;
    return this;
  }
  ...
  public NfeSefazEnderEmi CEP(@javax.annotation.Nullable String CEP) {
    this.CEP = CEP;
    return this;
  }
  ...
  public NfeSefazEnderEmi cPais(@javax.annotation.Nullable String cPais) {
    this.cPais = cPais;
    return this;
  }
  ...
  public NfeSefazEnderEmi xPais(@javax.annotation.Nullable String xPais) {
    this.xPais = xPais;
    return this;
  }
  ...
  public NfeSefazEnderEmi fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    NfeSefazEnderEmi nfeSefazEnderEmi = (NfeSefazEnderEmi) o;
    return Objects.equals(this.xLgr, nfeSefazEnderEmi.xLgr) &&
        Objects.equals(this.nro, nfeSefazEnderEmi.nro) &&
        Objects.equals(this.xCpl, nfeSefazEnderEmi.xCpl) &&
        Objects.equals(this.xBairro, nfeSefazEnderEmi.xBairro) &&
        Objects.equals(this.cMun, nfeSefazEnderEmi.cMun) &&
        Objects.equals(this.xMun, nfeSefazEnderEmi.xMun) &&
        Objects.equals(this.UF, nfeSefazEnderEmi.UF) &&
        Objects.equals(this.CEP, nfeSefazEnderEmi.CEP) &&
        Objects.equals(this.cPais, nfeSefazEnderEmi.cPais) &&
        Objects.equals(this.xPais, nfeSefazEnderEmi.xPais) &&
        Objects.equals(this.fone, nfeSefazEnderEmi.fone);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NfeSefazEnderEmi
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NfeSefazEnderEmi.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NfeSefazEnderEmi is not found in the empty JSON string", NfeSefazEnderEmi.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NfeSefazEnderEmi.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NfeSefazEnderEmi` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NfeSefazEnderEmi.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NfeSefazEnderEmi' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NfeSefazEnderEmi> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NfeSefazEnderEmi.class));

       return (TypeAdapter<T>) new TypeAdapter<NfeSefazEnderEmi>() {
           @Override
           public void write(JsonWriter out, NfeSefazEnderEmi value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NfeSefazEnderEmi read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NfeSefazEnderEmi given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NfeSefazEnderEmi
   * @throws IOException if the JSON string is invalid with respect to NfeSefazEnderEmi
   */
  public static NfeSefazEnderEmi fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NfeSefazEnderEmi.class);
  }

  /**
   * Convert an instance of NfeSefazEnderEmi to an JSON string
   *
   * @return JSON string
   */
