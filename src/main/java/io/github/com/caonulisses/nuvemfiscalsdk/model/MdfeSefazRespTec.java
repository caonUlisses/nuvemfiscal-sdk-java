...
public class MdfeSefazRespTec {
  ...
  public MdfeSefazRespTec() {
  }

  public MdfeSefazRespTec CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public MdfeSefazRespTec xContato(@javax.annotation.Nullable String xContato) {
  ...
  public MdfeSefazRespTec email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public MdfeSefazRespTec fone(@javax.annotation.Nullable String fone) {
    this.fone = fone;
    return this;
  }
  ...
  public MdfeSefazRespTec idCSRT(@javax.annotation.Nullable Integer idCSRT) {
    this.idCSRT = idCSRT;
    return this;
  }
  ...
  public MdfeSefazRespTec hashCSRT(@javax.annotation.Nullable String hashCSRT) {
  ...
  public boolean equals(Object o) {
    ...
    MdfeSefazRespTec mdfeSefazRespTec = (MdfeSefazRespTec) o;
    return Objects.equals(this.CNPJ, mdfeSefazRespTec.CNPJ) &&
        Objects.equals(this.xContato, mdfeSefazRespTec.xContato) &&
        Objects.equals(this.email, mdfeSefazRespTec.email) &&
        Objects.equals(this.fone, mdfeSefazRespTec.fone) &&
        Objects.equals(this.idCSRT, mdfeSefazRespTec.idCSRT) &&
        Objects.equals(this.hashCSRT, mdfeSefazRespTec.hashCSRT);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MdfeSefazRespTec
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MdfeSefazRespTec.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MdfeSefazRespTec is not found in the empty JSON string", MdfeSefazRespTec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MdfeSefazRespTec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MdfeSefazRespTec` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MdfeSefazRespTec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MdfeSefazRespTec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MdfeSefazRespTec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MdfeSefazRespTec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MdfeSefazRespTec.class));

       return (TypeAdapter<T>) new TypeAdapter<MdfeSefazRespTec>() {
           @Override
           public void write(JsonWriter out, MdfeSefazRespTec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MdfeSefazRespTec read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MdfeSefazRespTec given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MdfeSefazRespTec
   * @throws IOException if the JSON string is invalid with respect to MdfeSefazRespTec
   */
  public static MdfeSefazRespTec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MdfeSefazRespTec.class);
  }

  /**
   * Convert an instance of MdfeSefazRespTec to an JSON string
   *
   * @return JSON string
   */
