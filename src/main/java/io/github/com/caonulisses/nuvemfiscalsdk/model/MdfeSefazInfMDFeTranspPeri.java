...
public class MdfeSefazInfMDFeTranspPeri {
  ...
  public MdfeSefazInfMDFeTranspPeri() {
  }

  public MdfeSefazInfMDFeTranspPeri nONU(@javax.annotation.Nullable String nONU) {
    this.nONU = nONU;
    return this;
  }
  ...
  public MdfeSefazInfMDFeTranspPeri xNomeAE(@javax.annotation.Nullable String xNomeAE) {
  ...
  public MdfeSefazInfMDFeTranspPeri xClaRisco(@javax.annotation.Nullable String xClaRisco) {
  ...
  public MdfeSefazInfMDFeTranspPeri grEmb(@javax.annotation.Nullable String grEmb) {
    this.grEmb = grEmb;
    return this;
  }
  ...
  public MdfeSefazInfMDFeTranspPeri qTotProd(@javax.annotation.Nullable String qTotProd) {
  ...
  public MdfeSefazInfMDFeTranspPeri qVolTipo(@javax.annotation.Nullable String qVolTipo) {
  ...
  public boolean equals(Object o) {
    ...
    MdfeSefazInfMDFeTranspPeri mdfeSefazInfMDFeTranspPeri = (MdfeSefazInfMDFeTranspPeri) o;
    return Objects.equals(this.nONU, mdfeSefazInfMDFeTranspPeri.nONU) &&
        Objects.equals(this.xNomeAE, mdfeSefazInfMDFeTranspPeri.xNomeAE) &&
        Objects.equals(this.xClaRisco, mdfeSefazInfMDFeTranspPeri.xClaRisco) &&
        Objects.equals(this.grEmb, mdfeSefazInfMDFeTranspPeri.grEmb) &&
        Objects.equals(this.qTotProd, mdfeSefazInfMDFeTranspPeri.qTotProd) &&
        Objects.equals(this.qVolTipo, mdfeSefazInfMDFeTranspPeri.qVolTipo);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MdfeSefazInfMDFeTranspPeri
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MdfeSefazInfMDFeTranspPeri.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MdfeSefazInfMDFeTranspPeri is not found in the empty JSON string", MdfeSefazInfMDFeTranspPeri.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MdfeSefazInfMDFeTranspPeri.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MdfeSefazInfMDFeTranspPeri` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MdfeSefazInfMDFeTranspPeri.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MdfeSefazInfMDFeTranspPeri.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MdfeSefazInfMDFeTranspPeri' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MdfeSefazInfMDFeTranspPeri> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MdfeSefazInfMDFeTranspPeri.class));

       return (TypeAdapter<T>) new TypeAdapter<MdfeSefazInfMDFeTranspPeri>() {
           @Override
           public void write(JsonWriter out, MdfeSefazInfMDFeTranspPeri value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MdfeSefazInfMDFeTranspPeri read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MdfeSefazInfMDFeTranspPeri given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MdfeSefazInfMDFeTranspPeri
   * @throws IOException if the JSON string is invalid with respect to MdfeSefazInfMDFeTranspPeri
   */
  public static MdfeSefazInfMDFeTranspPeri fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MdfeSefazInfMDFeTranspPeri.class);
  }

  /**
   * Convert an instance of MdfeSefazInfMDFeTranspPeri to an JSON string
   *
   * @return JSON string
   */
