...
public class CteSefazICMS20 {
  ...
  public CteSefazICMS20() {
  }

  public CteSefazICMS20 CST(@javax.annotation.Nullable String CST) {
    this.CST = CST;
    return this;
  }
  ...
  public CteSefazICMS20 pRedBC(@javax.annotation.Nullable BigDecimal pRedBC) {
    this.pRedBC = pRedBC;
    return this;
  }
  ...
  public CteSefazICMS20 vBC(@javax.annotation.Nullable BigDecimal vBC) {
    this.vBC = vBC;
    return this;
  }
  ...
  public CteSefazICMS20 pICMS(@javax.annotation.Nullable BigDecimal pICMS) {
    this.pICMS = pICMS;
    return this;
  }
  ...
  public CteSefazICMS20 vICMS(@javax.annotation.Nullable BigDecimal vICMS) {
    this.vICMS = vICMS;
    return this;
  }
  ...
  public CteSefazICMS20 vICMSDeson(@javax.annotation.Nullable BigDecimal vICMSDeson) {
  ...
  public CteSefazICMS20 cBenef(@javax.annotation.Nullable String cBenef) {
    this.cBenef = cBenef;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CteSefazICMS20 cteSefazICMS20 = (CteSefazICMS20) o;
    return Objects.equals(this.CST, cteSefazICMS20.CST) &&
        Objects.equals(this.pRedBC, cteSefazICMS20.pRedBC) &&
        Objects.equals(this.vBC, cteSefazICMS20.vBC) &&
        Objects.equals(this.pICMS, cteSefazICMS20.pICMS) &&
        Objects.equals(this.vICMS, cteSefazICMS20.vICMS) &&
        Objects.equals(this.vICMSDeson, cteSefazICMS20.vICMSDeson) &&
        Objects.equals(this.cBenef, cteSefazICMS20.cBenef);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(CST, pRedBC, vBC, pICMS, vICMS, vICMSDeson, cBenef);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CteSefazICMS20
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CteSefazICMS20.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CteSefazICMS20 is not found in the empty JSON string", CteSefazICMS20.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CteSefazICMS20.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CteSefazICMS20` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CteSefazICMS20.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CteSefazICMS20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CteSefazICMS20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CteSefazICMS20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CteSefazICMS20.class));

       return (TypeAdapter<T>) new TypeAdapter<CteSefazICMS20>() {
           @Override
           public void write(JsonWriter out, CteSefazICMS20 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CteSefazICMS20 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CteSefazICMS20 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CteSefazICMS20
   * @throws IOException if the JSON string is invalid with respect to CteSefazICMS20
   */
  public static CteSefazICMS20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CteSefazICMS20.class);
  }

  /**
   * Convert an instance of CteSefazICMS20 to an JSON string
   *
   * @return JSON string
   */
