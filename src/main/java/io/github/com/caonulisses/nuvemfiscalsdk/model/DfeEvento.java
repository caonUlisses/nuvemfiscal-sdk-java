...
public class DfeEvento {
  ...
  public DfeEvento id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DfeEvento ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public DfeEvento status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DfeEvento autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public DfeEvento chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public DfeEvento dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public DfeEvento numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public DfeEvento dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public DfeEvento codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public DfeEvento motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public DfeEvento numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public DfeEvento codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public DfeEvento mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public DfeEvento tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    DfeEvento dfeEvento = (DfeEvento) o;
    return Objects.equals(this.id, dfeEvento.id) &&
        Objects.equals(this.ambiente, dfeEvento.ambiente) &&
        Objects.equals(this.status, dfeEvento.status) &&
        Objects.equals(this.autor, dfeEvento.autor) &&
        Objects.equals(this.chaveAcesso, dfeEvento.chaveAcesso) &&
        Objects.equals(this.dataEvento, dfeEvento.dataEvento) &&
        Objects.equals(this.numeroSequencial, dfeEvento.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, dfeEvento.dataRecebimento) &&
        Objects.equals(this.codigoStatus, dfeEvento.codigoStatus) &&
        Objects.equals(this.motivoStatus, dfeEvento.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, dfeEvento.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, dfeEvento.codigoMensagem) &&
        Objects.equals(this.mensagem, dfeEvento.mensagem) &&
        Objects.equals(this.tipoEvento, dfeEvento.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DfeEvento
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DfeEvento.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DfeEvento is not found in the empty JSON string", DfeEvento.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DfeEvento.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DfeEvento` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DfeEvento.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DfeEvento' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DfeEvento> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DfeEvento.class));

       return (TypeAdapter<T>) new TypeAdapter<DfeEvento>() {
           @Override
           public void write(JsonWriter out, DfeEvento value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DfeEvento read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DfeEvento given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DfeEvento
   * @throws IOException if the JSON string is invalid with respect to DfeEvento
   */
  public static DfeEvento fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DfeEvento.class);
  }

  /**
   * Convert an instance of DfeEvento to an JSON string
   *
   * @return JSON string
   */
