...
public class MdfeInclusaoCondutor {
  public static final String SERIALIZED_NAME_NOME_CONDUTOR = "nome_condutor";
  @SerializedName(SERIALIZED_NAME_NOME_CONDUTOR)
  @javax.annotation.Nullable
  private String nomeCondutor;

  public static final String SERIALIZED_NAME_CPF_CONDUTOR = "cpf_condutor";
  @SerializedName(SERIALIZED_NAME_CPF_CONDUTOR)
  @javax.annotation.Nullable
  ...
  public MdfeInclusaoCondutor() {
  }

  public MdfeInclusaoCondutor nomeCondutor(@javax.annotation.Nullable String nomeCondutor) {
  ...
  public void setNomeCondutor(@javax.annotation.Nullable String nomeCondutor) {
    this.nomeCondutor = nomeCondutor;
  }


  public MdfeInclusaoCondutor cpfCondutor(@javax.annotation.Nullable String cpfCondutor) {
  ...
  public void setCpfCondutor(@javax.annotation.Nullable String cpfCondutor) {
    this.cpfCondutor = cpfCondutor;
  }


  public MdfeInclusaoCondutor id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public MdfeInclusaoCondutor ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public MdfeInclusaoCondutor status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public MdfeInclusaoCondutor autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public MdfeInclusaoCondutor chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public MdfeInclusaoCondutor dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public MdfeInclusaoCondutor numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public MdfeInclusaoCondutor dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public MdfeInclusaoCondutor codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public MdfeInclusaoCondutor motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public MdfeInclusaoCondutor numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public MdfeInclusaoCondutor codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public MdfeInclusaoCondutor mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public MdfeInclusaoCondutor tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    MdfeInclusaoCondutor mdfeInclusaoCondutor = (MdfeInclusaoCondutor) o;
    return Objects.equals(this.nomeCondutor, mdfeInclusaoCondutor.nomeCondutor) &&
        Objects.equals(this.cpfCondutor, mdfeInclusaoCondutor.cpfCondutor) &&
        Objects.equals(this.id, mdfeInclusaoCondutor.id) &&
        Objects.equals(this.ambiente, mdfeInclusaoCondutor.ambiente) &&
        Objects.equals(this.status, mdfeInclusaoCondutor.status) &&
        Objects.equals(this.autor, mdfeInclusaoCondutor.autor) &&
        Objects.equals(this.chaveAcesso, mdfeInclusaoCondutor.chaveAcesso) &&
        Objects.equals(this.dataEvento, mdfeInclusaoCondutor.dataEvento) &&
        Objects.equals(this.numeroSequencial, mdfeInclusaoCondutor.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, mdfeInclusaoCondutor.dataRecebimento) &&
        Objects.equals(this.codigoStatus, mdfeInclusaoCondutor.codigoStatus) &&
        Objects.equals(this.motivoStatus, mdfeInclusaoCondutor.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, mdfeInclusaoCondutor.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, mdfeInclusaoCondutor.codigoMensagem) &&
        Objects.equals(this.mensagem, mdfeInclusaoCondutor.mensagem) &&
        Objects.equals(this.tipoEvento, mdfeInclusaoCondutor.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nomeCondutor, cpfCondutor, id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
  ...
  public String toString() {
    ...
    sb.append("    nomeCondutor: ").append(toIndentedString(nomeCondutor)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nome_condutor");
    openapiFields.add("cpf_condutor");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MdfeInclusaoCondutor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MdfeInclusaoCondutor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MdfeInclusaoCondutor is not found in the empty JSON string", MdfeInclusaoCondutor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MdfeInclusaoCondutor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MdfeInclusaoCondutor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("nome_condutor") != null && !jsonObj.get("nome_condutor").isJsonNull()) && !jsonObj.get("nome_condutor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nome_condutor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nome_condutor").toString()));
      }
      if ((jsonObj.get("cpf_condutor") != null && !jsonObj.get("cpf_condutor").isJsonNull()) && !jsonObj.get("cpf_condutor").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cpf_condutor` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cpf_condutor").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MdfeInclusaoCondutor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MdfeInclusaoCondutor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MdfeInclusaoCondutor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MdfeInclusaoCondutor.class));

       return (TypeAdapter<T>) new TypeAdapter<MdfeInclusaoCondutor>() {
           @Override
           public void write(JsonWriter out, MdfeInclusaoCondutor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MdfeInclusaoCondutor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MdfeInclusaoCondutor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MdfeInclusaoCondutor
   * @throws IOException if the JSON string is invalid with respect to MdfeInclusaoCondutor
   */
  public static MdfeInclusaoCondutor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MdfeInclusaoCondutor.class);
  }

  /**
   * Convert an instance of MdfeInclusaoCondutor to an JSON string
   *
   * @return JSON string
   */
