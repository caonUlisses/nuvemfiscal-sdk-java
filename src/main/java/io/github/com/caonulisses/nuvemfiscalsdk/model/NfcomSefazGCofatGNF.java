...
public class NfcomSefazGCofatGNF {
  ...
  public NfcomSefazGCofatGNF() {
  }

  public NfcomSefazGCofatGNF CNPJ(@javax.annotation.Nullable String CNPJ) {
    this.CNPJ = CNPJ;
    return this;
  }
  ...
  public NfcomSefazGCofatGNF mod(@javax.annotation.Nullable Integer mod) {
    this.mod = mod;
    return this;
  }
  ...
  public NfcomSefazGCofatGNF serie(@javax.annotation.Nullable String serie) {
    this.serie = serie;
    return this;
  }
  ...
  public NfcomSefazGCofatGNF nNF(@javax.annotation.Nullable Integer nNF) {
    this.nNF = nNF;
    return this;
  }
  ...
  public NfcomSefazGCofatGNF competEmis(@javax.annotation.Nullable String competEmis) {
  ...
  public NfcomSefazGCofatGNF hash115(@javax.annotation.Nullable String hash115) {
  ...
  public boolean equals(Object o) {
    ...
    NfcomSefazGCofatGNF nfcomSefazGCofatGNF = (NfcomSefazGCofatGNF) o;
    return Objects.equals(this.CNPJ, nfcomSefazGCofatGNF.CNPJ) &&
        Objects.equals(this.mod, nfcomSefazGCofatGNF.mod) &&
        Objects.equals(this.serie, nfcomSefazGCofatGNF.serie) &&
        Objects.equals(this.nNF, nfcomSefazGCofatGNF.nNF) &&
        Objects.equals(this.competEmis, nfcomSefazGCofatGNF.competEmis) &&
        Objects.equals(this.hash115, nfcomSefazGCofatGNF.hash115);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to NfcomSefazGCofatGNF
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NfcomSefazGCofatGNF.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NfcomSefazGCofatGNF is not found in the empty JSON string", NfcomSefazGCofatGNF.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NfcomSefazGCofatGNF.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NfcomSefazGCofatGNF` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NfcomSefazGCofatGNF.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NfcomSefazGCofatGNF.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NfcomSefazGCofatGNF' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NfcomSefazGCofatGNF> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NfcomSefazGCofatGNF.class));

       return (TypeAdapter<T>) new TypeAdapter<NfcomSefazGCofatGNF>() {
           @Override
           public void write(JsonWriter out, NfcomSefazGCofatGNF value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NfcomSefazGCofatGNF read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NfcomSefazGCofatGNF given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NfcomSefazGCofatGNF
   * @throws IOException if the JSON string is invalid with respect to NfcomSefazGCofatGNF
   */
  public static NfcomSefazGCofatGNF fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NfcomSefazGCofatGNF.class);
  }

  /**
   * Convert an instance of NfcomSefazGCofatGNF to an JSON string
   *
   * @return JSON string
   */
