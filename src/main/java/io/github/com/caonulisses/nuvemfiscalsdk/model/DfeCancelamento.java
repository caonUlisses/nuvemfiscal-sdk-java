...
public class DfeCancelamento {
  ...
  public DfeCancelamento() {
  }

  public DfeCancelamento justificativa(@javax.annotation.Nullable String justificativa) {
  ...
  public DfeCancelamento id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public DfeCancelamento ambiente(@javax.annotation.Nullable AmbienteEnum ambiente) {
  ...
  public DfeCancelamento status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DfeCancelamento autor(@javax.annotation.Nullable DfeAutorEvento autor) {
    this.autor = autor;
    return this;
  }
  ...
  public DfeCancelamento chaveAcesso(@javax.annotation.Nullable String chaveAcesso) {
  ...
  public DfeCancelamento dataEvento(@javax.annotation.Nullable OffsetDateTime dataEvento) {
  ...
  public DfeCancelamento numeroSequencial(@javax.annotation.Nullable Integer numeroSequencial) {
  ...
  public DfeCancelamento dataRecebimento(@javax.annotation.Nullable OffsetDateTime dataRecebimento) {
  ...
  public DfeCancelamento codigoStatus(@javax.annotation.Nullable Integer codigoStatus) {
  ...
  public DfeCancelamento motivoStatus(@javax.annotation.Nullable String motivoStatus) {
  ...
  public DfeCancelamento numeroProtocolo(@javax.annotation.Nullable String numeroProtocolo) {
  ...
  public DfeCancelamento codigoMensagem(@javax.annotation.Nullable Integer codigoMensagem) {
  ...
  public DfeCancelamento mensagem(@javax.annotation.Nullable String mensagem) {
  ...
  public DfeCancelamento tipoEvento(@javax.annotation.Nullable String tipoEvento) {
  ...
  public boolean equals(Object o) {
    ...
    DfeCancelamento dfeCancelamento = (DfeCancelamento) o;
    return Objects.equals(this.justificativa, dfeCancelamento.justificativa) &&
        Objects.equals(this.id, dfeCancelamento.id) &&
        Objects.equals(this.ambiente, dfeCancelamento.ambiente) &&
        Objects.equals(this.status, dfeCancelamento.status) &&
        Objects.equals(this.autor, dfeCancelamento.autor) &&
        Objects.equals(this.chaveAcesso, dfeCancelamento.chaveAcesso) &&
        Objects.equals(this.dataEvento, dfeCancelamento.dataEvento) &&
        Objects.equals(this.numeroSequencial, dfeCancelamento.numeroSequencial) &&
        Objects.equals(this.dataRecebimento, dfeCancelamento.dataRecebimento) &&
        Objects.equals(this.codigoStatus, dfeCancelamento.codigoStatus) &&
        Objects.equals(this.motivoStatus, dfeCancelamento.motivoStatus) &&
        Objects.equals(this.numeroProtocolo, dfeCancelamento.numeroProtocolo) &&
        Objects.equals(this.codigoMensagem, dfeCancelamento.codigoMensagem) &&
        Objects.equals(this.mensagem, dfeCancelamento.mensagem) &&
        Objects.equals(this.tipoEvento, dfeCancelamento.tipoEvento);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(justificativa, id, ambiente, status, autor, chaveAcesso, dataEvento, numeroSequencial, dataRecebimento, codigoStatus, motivoStatus, numeroProtocolo, codigoMensagem, mensagem, tipoEvento);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DfeCancelamento
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DfeCancelamento.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DfeCancelamento is not found in the empty JSON string", DfeCancelamento.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DfeCancelamento.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DfeCancelamento` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DfeCancelamento.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DfeCancelamento' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DfeCancelamento> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DfeCancelamento.class));

       return (TypeAdapter<T>) new TypeAdapter<DfeCancelamento>() {
           @Override
           public void write(JsonWriter out, DfeCancelamento value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DfeCancelamento read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DfeCancelamento given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DfeCancelamento
   * @throws IOException if the JSON string is invalid with respect to DfeCancelamento
   */
  public static DfeCancelamento fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DfeCancelamento.class);
  }

  /**
   * Convert an instance of DfeCancelamento to an JSON string
   *
   * @return JSON string
   */
